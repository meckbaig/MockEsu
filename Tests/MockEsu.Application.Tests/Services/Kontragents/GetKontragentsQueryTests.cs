...
public class GetKontragentsQueryTests //: KontragentsApiFactory
{
    ...
    public GetKontragentsQueryTests()
    {
        ...
        _cachedKeysProvider = Substitute.For<ICachedKeysProvider>();
    }
    ...
    //    var handler = new GetKontragentsQueryHandler(contextMock.Object, _mapper, _cache, _cachedKeysProvider);
